...
export class CardEditor {
  ...
  constructor(editor: CIVideoHotspotEditor, overlayEl: HTMLElement, modalEl: HTMLElement, demoMode = false) {
    this.editor = editor;
  ...
  open(hotspotId: string): void {
    ...
    fields.forEach(({ key, label, type }) => {
      // In demo mode, hide the image URL field
      if (this.demoMode && key === 'image') return;
